...
export class HousingService {
  ...
  public async getHousingLocationById(id: number): Promise<HousingLocation | undefined> {
    try {
      ...
      return new Promise(resolve => {
        resolve(this.getMockLocationById(id));
      });
    }
  }
  ...
  private getMockLocationById(id: number): HousingLocation | undefined {
    return this.locations.find(housingLocation => housingLocation.id === id);
  }
}
